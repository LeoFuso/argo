 ...
 */
class SchemaParserSupplier(private val runner: CompileCommandRunner) : Supplier<DependencyGraphAwareSchemaParser> {
    override fun get(): DependencyGraphAwareSchemaParser = DefaultSchemaParser(runner)
}
